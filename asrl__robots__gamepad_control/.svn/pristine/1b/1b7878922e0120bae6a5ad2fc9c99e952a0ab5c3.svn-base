...
namespace asrl {
  ...
  public:
     ...
     * twist messages.
     */
    GamepadControl(const ros::NodeHandle & nh);
  ...
  GamepadControl::GamepadControl(const ros::NodeHandle & nh) : nodeHandle_(nh)
  {
    ...
    asrl::rosutil::param(nodeHandle_, "base/vertical_max", verticalMax_, 0.5 );
  ...
  void GamepadControl::joyCallback(const sensor_msgs::Joy::ConstPtr& joy)
  {
    std_msgs::Bool msg;
