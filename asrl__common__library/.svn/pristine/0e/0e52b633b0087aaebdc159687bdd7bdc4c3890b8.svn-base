#ifndef ASRL_NUMERICAL_DIFF_HPP
#define ASRL_NUMERICAL_DIFF_HPP
...
namespace asrl { namespace eigen {
	...
	ASRL_ASSERT_EQ(std::runtime_error,x0.size(),J.cols(),"Unexpected number of columns for input size");
	ASRL_ASSERT_EQ(std::runtime_error,fx0.size(),J.rows(),"Unexpected number of columns for output size");	
