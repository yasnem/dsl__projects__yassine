...
void ArServerHandlerConfig::restartIO(const char *reason)
{
...
void ArServerHandlerConfig::restartSoftware(const char *reason)
{
...
void ArServerHandlerConfig::restartHardware(const char *reason)
{
