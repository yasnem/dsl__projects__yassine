...
public class ArNetServer {
  ...
  public ArNetServer(boolean addAriaExitCB, boolean doNotAddShutdownServer) {
    this(AriaJavaJNI.new_ArNetServer__SWIG_0(addAriaExitCB, doNotAddShutdownServer), true);
  }

  public ArNetServer(boolean addAriaExitCB) {
    this(AriaJavaJNI.new_ArNetServer__SWIG_1(addAriaExitCB), true);
  }

  public ArNetServer() {
    this(AriaJavaJNI.new_ArNetServer__SWIG_2(), true);
  }
