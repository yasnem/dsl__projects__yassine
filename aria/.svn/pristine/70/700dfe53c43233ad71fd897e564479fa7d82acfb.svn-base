...
public class ArRobotParams extends ArConfig {
  ...
  public SWIGTYPE_p_double internalGetDistConvFactorPointer() {
    long cPtr = AriaJavaJNI.ArRobotParams_internalGetDistConvFactorPointer(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_double(cPtr, false);
  }

  public static void internalSetUseDefaultBehavior(boolean useDefaultBehavior, String owerOutputDisplayHint) {
    AriaJavaJNI.ArRobotParams_internalSetUseDefaultBehavior(useDefaultBehavior, owerOutputDisplayHint);
  }

  public static boolean internalGetUseDefaultBehavior() {
    return AriaJavaJNI.ArRobotParams_internalGetUseDefaultBehavior();
  }

  public void internalAddToConfigCommercial(ArConfig config) {
    AriaJavaJNI.ArRobotParams_internalAddToConfigCommercial(swigCPtr, this, ArConfig.getCPtr(config), config);
  }

  public void internalAddToConfigDefault() {
    AriaJavaJNI.ArRobotParams_internalAddToConfigDefault(swigCPtr, this);
  }
