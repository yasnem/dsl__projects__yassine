...
AREXPORT ArRobotPioneerLX::ArRobotPioneerLX(const char *dir)
{
  ...
  */
  ...
  // Front:
  internalSetSonar(0,  331,  61,   10,     1,    1,   0,     0,  400);
  internalSetSonar(1,  331, -61,  -10,     1,    2,   0,     0,  400);
  // back:
  internalSetSonar(2, -317,  90,  164,     1,    3,   0,     0,  500);
  internalSetSonar(3, -317, -90, -164,     1,    4,   0,     0,  500);
