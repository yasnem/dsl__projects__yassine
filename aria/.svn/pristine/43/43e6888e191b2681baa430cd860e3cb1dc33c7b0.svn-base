...
GCC 3.4 if on Linux, and MS Visual C++ 2010 (10.0), and Visual C++ 
2012 (11) if on Windows.  Project files are also provided to build 
ARIA on MS Visual Studio .NET 2003 (7.1) or Visual C++ 2008 (9.0) 
as well. Using these compilers for development is recommended. 
...
examples/All_examples-vc2012.sln
				  MSVC++ 2012 solution for building all of the examples
...
Visual C++ 2008 (VC9), Visual C++ 2010 (VC10), or Visual C++ 2012 (VC11).
...
5. Click on the "Link" or "Linker" section.
  ...
  * Click on the "Input" subsection.
	...
	* (Visual C++ 2010) To "Additional Dependencies", add:
        AriaDebugVC10.lib winmm.lib advapi32.lib
      If you are using the ArNetworking library, also add:
        ArNetworkingDebugVC10.lib ws2_32.lib
		
	* (Visual C++ 2012) To "Additional Dependencies", add:
        AriaDebugVC11.lib winmm.lib advapi32.lib
      If you are using the ArNetworking library, also add:
        ArNetworkingDebugVC11.lib ws2_32.lib
    ...
    * (Visual C++ 2010) To "Additional Dependencies", add:
        AriaVC10.lib winmm.lib advapi32.lib
      If you are using the ArNetworking library, also add:
        ArNetworkingVC10.lib ws2_32.lib

	* (Visual C++ 2012) To "Additional Dependencies", add:
        AriaVC11.lib winmm.lib advapi32.lib
      If you are using the ArNetworking library, also add:
        ArNetworkingVC11.lib ws2_32.lib
