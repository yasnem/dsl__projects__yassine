...
class ArConfigArg(object):
    ...
    def setString(self, *args):
        ...
        setString(self, char str) -> bool
        setString(self, string str, char errorBuffer = None, size_t errorBufferLen = 0, 
            bool doNotSet = False) -> bool
        setString(self, string str, char errorBuffer = None, size_t errorBufferLen = 0) -> bool
        setString(self, string str, char errorBuffer = None) -> bool
        setString(self, string str) -> bool
        """
    ...
    def getSupressChanges(self):
        """getSupressChanges(self) -> bool"""
        return _AriaPy.ArConfigArg_getSupressChanges(self)

    def setSupressChanges(self, *args):
        """setSupressChanges(self, bool supressChanges)"""
        return _AriaPy.ArConfigArg_setSupressChanges(self, *args)
...
class ArNetServer(object):
    ...
    def __init__(self, addAriaExitCB = True, doNotAddShutdownServer = False): 
        ...
        """
        this = _AriaPy.new_ArNetServer(addAriaExitCB, doNotAddShutdownServer)
        try: self.this.append(this)
        except: self.this = this
...
class ArRobot(object):
    ...
    def dropConnection(self, reason = "Lost connection to the robot because of undefined error."):
        """
        dropConnection(self, char reason = "Lost connection to the robot because of undefined error.")
        dropConnection(self)
        """
        return _AriaPy.ArRobot_dropConnection(self, reason)
...
class ArRobotParams(ArConfig):
    ...
    def internalGetDistConvFactorPointer(self):
        """internalGetDistConvFactorPointer(self) -> double"""
        return _AriaPy.ArRobotParams_internalGetDistConvFactorPointer(self)

    def internalSetUseDefaultBehavior(*args):
        """internalSetUseDefaultBehavior(bool useDefaultBehavior, char owerOutputDisplayHint)"""
        return _AriaPy.ArRobotParams_internalSetUseDefaultBehavior(*args)

    internalSetUseDefaultBehavior = staticmethod(internalSetUseDefaultBehavior)
    def internalGetUseDefaultBehavior():
        """internalGetUseDefaultBehavior() -> bool"""
        return _AriaPy.ArRobotParams_internalGetUseDefaultBehavior()

    internalGetUseDefaultBehavior = staticmethod(internalGetUseDefaultBehavior)
    def internalAddToConfigCommercial(self, *args):
        """internalAddToConfigCommercial(self, ArConfig config)"""
        return _AriaPy.ArRobotParams_internalAddToConfigCommercial(self, *args)

    def internalAddToConfigDefault(self):
        """internalAddToConfigDefault(self)"""
        return _AriaPy.ArRobotParams_internalAddToConfigDefault(self)
...
def ArRobotParams_internalSetUseDefaultBehavior(*args):
  """ArRobotParams_internalSetUseDefaultBehavior(bool useDefaultBehavior, char owerOutputDisplayHint)"""
  return _AriaPy.ArRobotParams_internalSetUseDefaultBehavior(*args)

def ArRobotParams_internalGetUseDefaultBehavior():
