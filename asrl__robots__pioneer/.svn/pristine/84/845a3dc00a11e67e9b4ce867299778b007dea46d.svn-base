...
AngleConvFactor 0.0017 ; radians per angular unit (2PI/4096), was 0.001534
DistConvFactor 1         ; multiplier to mm from robot units, was 1
VelConvFactor 1          ; multiplier to mm/sec from robot units, was 1
...
RotAccel 1             ; rotational acceleration
RotDecel 1             ; rotational deceleration
...
LaserCumulativeBufferSize 0 ; Cumulative buffer size to use for the laser, 0 to
                         ; use default
LaserX 125               ; x location of laser, mm
