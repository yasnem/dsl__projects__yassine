...
#define IDENT_DRP_H "$Id: drp.h,v 1.3 2014/03/27 21:26:52 pberger Exp $"
...
struct un_struct {
    ...
    wait_queue_head_t  un_open_wait;	/* Do I really need to explain? */
    wait_queue_head_t  un_close_wait;	/* See above explanation */
    ushort	un_type;
...
struct nd_struct {
	...
	struct semaphore nd_writebuf_semaphore; /* Protects access to the
						 * writebuf below
						 */
	uchar	     *nd_writebuf;		/* Used to cache data read
						 * from user
						 */
